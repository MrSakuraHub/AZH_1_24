    ...
    <div className="f">
      <div className="overlap-group-wrapper">
        <div className="overlap-group">
          ...
          <Blob12 className="blob1-2" />
          <div className="frame">
            <Blob11 className="blob1-1" color="#28CD6A" />
            ...
            <div className="frame-7">
              <div className="frame-8">
                <div className="frame-9">
                  ...
                  <div className="expand-arrows-wrapper">
                    <ExpandArrows4 className="expand-arrows" />
                  </div>
                </div>
                <div className="frame-10">
                  ...
                  <div className="list">
                    <div className="frame-11">
                      <Xmr1 className="icon-instance-node" />
                      <div className="center-list-item">
                        <div className="text-wrapper-2">Bitcoin</div>
                        <div className="text-wrapper-3">BTC</div>
                      </div>
                  ...
                  <div className="list">
                    <div className="frame-11">
                      <Usdc1 className="icon-instance-node" />
                      <div className="center-list-item">
                        <div className="text-wrapper-2">Bitcoin</div>
                        <div className="text-wrapper-3">BTC</div>
                      </div>
                  ...
                  <div className="list">
                    <div className="frame-11">
                      <Algo1 className="icon-instance-node" />
                      <div className="center-list-item">
                        <div className="text-wrapper-2">Bitcoin</div>
                        <div className="text-wrapper-3">BTC</div>
                      </div>
                  ...
                  <img className="line-3" alt="Line" src="/img/line-27-2.png" />
                ...
                <div className="frame-14">
                  <div className="frame-15">
                        ...
                        <div className="frame-17">
                          <div className="div-wrapper">
                            <div className="music-wrapper">
                              <Music1 className="music-1" />
                            </div>
                          </div>
                          <img className="rectangle-2" alt="Rectangle" src="/img/rectangle-2330.png" />
                        </div>
                    ...
                    <div className="frame-16">
                      <div className="rectangle-wrapper">
                        <img className="rectangle-3" alt="Rectangle" src="/img/rectangle-2330-1.png" />
                      </div>
                      <div className="caption-wrapper">
                  ...
                  <div className="frame-15">
                    <div className="frame-18">
                      <div className="rectangle-wrapper">
                        <img className="rectangle-4" alt="Rectangle" src="/img/rectangle-2330-3.png" />
                      </div>
                      <div className="caption-wrapper">
                        <div className="text-wrapper-4">Muramaki flow...</div>
                      </div>
                  ...
                  <img className="line-4" alt="Line" src="/img/line-27-2.png" />
                  <div className="list">
                    <div className="frame-11">
                      <LinkWrapper />
                      <div className="center-list-item">
                  ...
                  <img className="line-5" alt="Line" src="/img/line-27-2.png" />
                  <div className="list">
                    <div className="frame-11">
                      <XmrWrapper />
                      <div className="center-list-item">
                  ...
                  <img className="line-6" alt="Line" src="/img/line-27-2.png" />
                  <div className="list">
                    <div className="frame-11">
                      <UsdcWrapper />
                      <div className="center-list-item">
                  ...
                  <img className="line-7" alt="Line" src="/img/line-27-2.png" />
                  <div className="list">
                    <div className="frame-11">
                      <Algo />
                      <div className="center-list-item">
                  ...
                  <img className="line-8" alt="Line" src="/img/line-27-2.png" />
                  <div className="rectangle" />
                  <div className="rectangle" />
                  <div className="rectangle" />
                  <div className="rectangle" />
              ...
              <div className="frame-19">
                ...
                <div className="frame-10">
                  ...
                  <img className="line-2" alt="Line" src="/img/line-26-2.svg" />
                  <div className="list-2">
                    <div className="frame-11">
                      <div className="frame-21">
                  ...
                  <img className="line-9" alt="Line" src="/img/line-27-2.png" />
                  <div className="list">
                    <div className="frame-11">
                      <Algo />
                      <div className="center-list-item">
                  ...
                  <img className="line-10" alt="Line" src="/img/line-27-2.png" />
                  <div className="rectangle" />
                  <div className="rectangle" />
                  <div className="rectangle" />
                  <div className="rectangle" />
              ...
              <div className="frame-22">
                ...
                <div className="frame-10">
                  ...
                  <img className="line-2" alt="Line" src="/img/line-27-3.svg" />
                  <div className="list-3">
                    <div className="frame-11">
                      <div className="frame-21">
